...
public class AppTest {
	...
	private void viewSessionDetails() {
		...
		driver.findElement(By.id("session-details-time"));
		...
		driver.findElement(By.id("numTickets"));
		driver.findElement(By.id("bankCard"));
		driver.findElement(By.id("buy-form-submit"));
	}
